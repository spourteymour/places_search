...
//  SnoopTest
//
//  Created by Sepandat Pourtaymour on 23/04/2020.
...
extension AnyCodable: Codable {
	...
	public func encode(to encoder: Encoder) throws {
		...
		case let value as Array<Any?>: try container.encode(value.map { AnyCodable($0) })
		case let value as Dictionary<String, Any?>: try container.encode(value.mapValues { AnyCodable($0) })
		case let value as Float: try container.encode(value)
		case let value as Double: try container.encode(value)
		case let value as Decimal: try container.encode(value)
		case let value as NSDecimalNumber: try container.encode(value.decimalValue)
		case is NSNull: try container.encodeNil()
		case let value as NSNumber: try container.encode(value.doubleValue)
		default:
			let context = EncodingError.Context( codingPath: container.codingPath, debugDescription: "Invalid value cannot be encoded")
...
extension AnyCodable: Equatable {
	public static func == (lhs: AnyCodable, rhs: AnyCodable) -> Bool {
		...
		case (let lhs as Int8, let rhs as Int8): return lhs == rhs
		case (let lhs as Int16, let rhs as Int16): return lhs == rhs
		case (let lhs as Int32, let rhs as Int32): return lhs == rhs
		case (let lhs as Int64, let rhs as Int64): return lhs == rhs
		case (let lhs as UInt, let rhs as UInt): return lhs == rhs
		case (let lhs as UInt8, let rhs as UInt8): return lhs == rhs
		case (let lhs as UInt16, let rhs as UInt16): return lhs == rhs
		case (let lhs as UInt32, let rhs as UInt32): return lhs == rhs
		case (let lhs as UInt64, let rhs as UInt64): return lhs == rhs
		case (let lhs as Float, let rhs as Float): return lhs == rhs
		case (let lhs as Double, let rhs as Double): return lhs == rhs
		case (let lhs as [String: AnyCodable], let rhs as [String: AnyCodable]): return lhs == rhs
		case (let lhs as [AnyCodable], let rhs as [AnyCodable]): return lhs == rhs
...
extension AnyCodable: CustomStringConvertible {
	public var description: String {
		...
		default: return String(describing: self.value)
		}
	}
}
...
extension AnyCodable: CustomDebugStringConvertible {
	public var debugDescription: String {
		switch self.value {
		case let value as CustomDebugStringConvertible: return value.debugDescription
